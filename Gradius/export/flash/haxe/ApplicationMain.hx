...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/nivel.oel");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/data/nivel.oep");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/images/Apuntador.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/brain.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/moco.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/rocas.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/spaceship.png");
		types.push (lime.Assets.AssetType.IMAGE);
